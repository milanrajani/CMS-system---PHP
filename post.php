                ...
                <div class="well">
                    ...
                    <form action="" method="post" class="form" require>
                        <div class="form-group">
                            <input type="email"  class="form-control" name="comment_email" placeholder="Email" require_once>
                        </div>
                        <div class="form-group">
                            <textarea  id=""  rows="3"  class="form-control"  name="comment_author" placeholder="leave a query"></textarea>
                        </div>
